...
namespace SortingPlayground
{
    internal class Program
    {
        ...
        static int[] BubbleSort(int[] array)
        {
             ...
             */
            //vzdycky dva sousedici srovnam a seradim
            int temporary;
            for (int j = 0; j < sortedArray.Length; j++)
            {
                if (sortedArray[j] > sortedArray [j+1])
                {
                    ...
                    {
                        temporary = sortedArray[i - 1];
                        if (temporary > sortedArray[i])
                        {
                            sortedArray[i - 1] = sortedArray[i];
                            sortedArray[i] = temporary;
                        }
                    }
                }
            }
        ...
        static int[] SelectionSort(int[] array)
        {
             ...
             */
            //positionToHold, cast do ktere nesaham
            return sortedArray;
        }
        ...
        static int[] InsertionSort(int[] array)
        {
             ...
             */
            //vezmu dalsi cislo a zaradim ho do jiz serazene casti, prohazuji postupne se vsim, co je mensi (musim porovnavat dokud to tam nepatri)
            return sortedArray;
        }
